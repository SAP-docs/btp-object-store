[![REUSE status](https://api.reuse.software/badge/github.com/SAP-docs/btp-object-store)](https://api.reuse.software/info/github.com/SAP-docs/btp-object-store)

# Contributions to the SAP BTP Object Store Documentation

Found a mistake in our documentation? Always wanted to add a step in one of our procedures that could save many others much time? Then you're at the right place! All contributions made to the Markdown files in the [docs](docs) directory are reviewed, and if deemed valuable be added to our [official documentation on SAP Help Portal](https://help.sap.com/docs/object-store/object-store-service-on-sap-btp/). The easiest way is to start there, and choose _Edit_ to find the right Markdown file to contribute to.
...
We recommend using the SAP BTP Object Store documentation on SAP Help Portal as a starting point for contributions:

1. Open the [SAP BTP Object Store documentation](https://help.sap.com/docs/object-store/object-store-service-on-sap-btp/).
1. You can either:
